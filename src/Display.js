	...
	return (
      <div>
	      <div className='bg-pink pa3'>
	    	<h1 style={{color: "darkblue"}}>Tic Tac Toe</h1>
    		<button style={{margin: "5px", background: "white"}} onClick={Bot}>1-Player</button>
    		<button style={{margin: "5px", background: "white"}} onClick={TwoP}>2-Player</button>
    		<button style={{margin: "5px", background: "white"}} onClick={reset}>Reset</button>
	    	<h2 style={{color: "darkblue"}} id='player'>{player}</h2>
	    	...
	    	<h3 style={{color: "darkblue"}} id='msg'>{winner}</h3>
	      </div>
	      <div>
